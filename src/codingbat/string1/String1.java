...
public class String1 {
    ...
    public String deFront(String str) {
        ...
        if (str.charAt(0) == 'a' && str.charAt(1) != 'b') return str.charAt(0) + str.substring(2);
        if (str.charAt(0) != 'a' && str.charAt(1) == 'b') return str.substring(1);
    ...
    public String startWord(String str, String word) {
        ...
        if (str.length() >= word.length()) {
            temp = str.substring(1, word.length());
            if (word.substring(1).equals(temp)) return str.charAt(0) + temp;
            else return "";
        } else return "";
    }
    ...
    public String withoutX2(String str) {
        if ((str.length() <= 1) || (str.length() == 2 && str.charAt(0) == 'x' && str.charAt(1) == 'x'))
            return "";
